...
/**
 * Community Auth - News Controller
 *
...
class News extends MY_Controller
{
     ...
     * Remember to add "News/optional_login_test" to the
    ...
    public function optional_login_test()
    {
        ...
        echo $this->load->view('News/page_header', '', TRUE);

        echo $page_content;

        echo $this->load->view('News/page_footer', '', TRUE);
    }
    ...
    public function create_user()
    {
        ...
        $user_data = array(
            ...
            'user_email'    => 'skunkbot@New.com',
            'user_level'    => '1', // 9 if you want to login @ News/index.
        );
    ...
    public function recover()
    {
        ...
        else
        {
            ...
            {
                if( $user_data = $this->News_model->get_recovery_data( $this->input->post('user_email') ) )
                {
                    ...
                    else
                    {
                        ...
                        $this->News_model->update_user_raw_data(
                            $user_data->user_id,
                            array(
                        ...
                        $view_data['special_link'] = secure_anchor( 
                            'News/recovery_verification/' . $user_data->user_id . '/' . $recovery_code, 
                            secure_site_url( 'News/recovery_verification/' . $user_data->user_id . '/' . $recovery_code ), 
                            'target ="_blank"' 
                        );
    ...
    public function recovery_verification( $user_id = '', $recovery_code = '' )
    {
        ...
        else
        {
            ...
            if( 
                 ...
                 */
                $recovery_data = $this->News_model->get_recovery_verification_data( $user_id ) )
            {
                /**
            ...
            {
                $this->News_model->recovery_password_change();
            }
        }

        echo $this->load->view('News/page_header', '', TRUE);

        echo $this->load->view( 'News/choose_password_form', $view_data, TRUE );
